...
def get_login_name(first, last, idnumber):
    # Get teh first three leters of the first name.
    # If the name is less than 3 characters, the 
    # slice will return the entire first name. 
    set1 = first[0 : 3]

    # Get the first threee letters of the last name.
    # If thename is less than 3 characters, the
...
# # an argument and returns either true of false to 
...
def valid_password(password):
    ...
    if len(password) >= 7:
        ...
        # appropriate flag when required
        # character is found.
        for ch in password:
            if ch.isupper():
                has_uppercase = True
