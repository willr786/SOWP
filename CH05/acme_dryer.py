...
# The main function performs the program's logic.
def main():
...
# program's initial message on teh screen.
def startup_message():
    print('This program tells you how to')
    print('disassemble an ACME laundry dryer.')
    print('The are 4 steps in the process.')
    print()

# The step1 function displays the instrucitons
# for step 1.
def step1():
    print('Step 1: Unplug the dryer and')
    print('move it away form the wall.')
    print()

# The step2 function displays the instructions 
# for step 2.
def step2():
    print('Step 2: Remvoe the six screws')
