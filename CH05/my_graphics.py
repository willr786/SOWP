...
# are the coordinates of teh lower-left corner.  The width
# parameter is the width of each side.  The color paramether
...
# The circle funciton draws a circle.  The x and y parameters
...
# The line function draws a lne from (startX, startY)
# to the (endX, endY).  The color parameter is the line's color.
