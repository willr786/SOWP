# This program assistes a technician in the process 
...
temperature = float(input("Enter the substanc's Cessius temperature: "))
...
# Reming the user to check the temperature again 
# in 15 minutes.
